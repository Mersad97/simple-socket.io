...
//     if (!req.file) return res.fail("فایلی ارسال نشده", 400);

//     // const fileUrl = `/api/files/${req.file.filename}`;
//     const fileUrl = `${process.env.BACKEND_URL}/api/files/${req.file.filename}`;
...
//     return res.success("فایل آپلود شد", message);
//   } catch (error) {
//     logger.error("upload error", error);
//     return res.fail("خطا در آپلود فایل", 500);
//   }
// };
